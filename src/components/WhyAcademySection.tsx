...
export default function WhyAcademySection({ language }: WhyAcademySectionProps) {
    ...
    const content = {
        ...
        he: {
            title: "למה אקדמיית A+?",
            description:
                "עם יותר מ־44 שנות ניסיון משולבות בהוראה, אקדמיית +A עזרה ליותר מ־1,000 תלמידים לשפר את הישגיהם ולהצליח במתמטיקה. שיעור ההצלחה המוכח שלנו של 98% מעיד על המחויבות שלנו למצוינות. אנו משלבים מומחיות, תשומת לב אישית ושיטות הוראה חדשניות, כדי לאפשר לכל תלמיד לממש את היכולת שלו במתמטיקה.",
            stats: [
            ...
            features: [
                {
                    text: "תוכנית לימוד אישית עם יעדים ברורים והתקדמות מדידה",
                },
                {
                    text: "חיזוק יסודות במתמטיקה – הבנה, תרגול וביטחון עצמי",
                },
                {
                    text: "קבוצות קטנות, יחס אישי וליווי צמוד לאורך הדרך",
                }
            ]
        },
    };
