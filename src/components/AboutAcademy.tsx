    ...
    const content = {
        ...
        he: {
            ...
            text: (
                <>
                    <p className="mb-0">
                        אקדמיית A+ נולדה מתוך אהבה אמיתית למתמטיקה והבנה עמוקה של האתגרים שתלמידים מתמודדים איתם בדרכם להצלחה.
                    </p>
                    <p className="mb-0">האקדמיה נוסדה על ידי</p>
                    <p className="mb-0">
                        מורות המתמטיקה אימאן טנוס ורודינה סוסאן, המביאות שנים רבות של ניסיון בהוראה, חונכות תלמידים והכנתם להישגים גבוהים - לא רק בציונים, אלא גם בביטחון ובמחשבה.
                    </p>
                    <p className="mb-0">&nbsp;</p>
                    <p className="mb-0">
                        אנו מאמינים שמתמטיקה לא צריכה להיות מאיימת.
                    </p>
                    <p>
                        באמצעות גישה אישית, הסברים ברורים, סבלנות ותשומת לב אישית לכל תלמיד, אנו הופכים חומר מורכב למשהו פשוט, ברור ואפילו מהנה
                    </p>
                </>
            ),
        },
